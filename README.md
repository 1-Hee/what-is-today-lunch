...
## 오늘 점심 뭐야? (what-is-today-lunch)

### 프로젝트 진행 기간 : 2023. 01. 08. ~

## 📜 History
- 프로젝트 기획 (2023. 01. 08.)
- 빠른 web-site 디자인이 가능하게 해주는 Tool Figma 학습후 적용 (2023. 01. 13 ~ )
- Figma로 디자인하고, scss로 css를 컨버팅 한 html 및 css 파일 생성 및 업로드 (2023. 01. 15)
- raw-html 파일로부터 react 컴포넌트로 변환 작업 (2023. 01. 15. ~ )
...
오늘 점심은 뭐지? 매번 물어보기 귀찮으셨죠? 우리 서비스는 단체, 기관에서 반자동으로 점심 메뉴를 알려드립니다.
점심 메뉴 공유 서비스의 위키백과!, 사용자 참여로 운영되는 점심 메뉴 공유 서비스, 당신의 점심 시간을 즐겁게 해드립니다.
더불어 오늘의 점심에 대한 호응도를 파악 가능한 레이팅 시스템까지! 이젠 맛있는 점심과 함께 스낵 같은 우리 서비스를 즐겨보세요 🎉


### [오늘 점심 뭐야] 메인페이지(랜딩페이지)
|||
|---|---|
